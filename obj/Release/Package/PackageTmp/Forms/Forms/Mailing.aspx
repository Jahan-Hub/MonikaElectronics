<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mailing.aspx.cs" Inherits="ElectronicsMS.Forms.Forms.Mailing" %>
                                            ...
                                            <telerik:RadGrid ID="RGSelect" runat="server" AutoGenerateColumns="False" GridLines="Both" OnEditCommand="RGSelect_EditCommand" OnItemDataBound="RGSelect_ItemDataBound" OnNeedDataSource="RGSelect_NeedDataSource" ShowFooter="True">
                                                ...
                                                <MasterTableView BorderWidth="0" EditMode="InPlace" Width="100%">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <telerik:GridBoundColumn DataField="Name" AutoPostBackOnFilter="true"  FilterControlAltText="Filter Name column" FilterImageUrl="Filter.gif" HeaderText="Name" SortAscImageUrl="SortAsc.gif" SortDescImageUrl="SortDesc.gif" SortExpression="Name" UniqueName="Name">
                                                        </telerik:GridBoundColumn>
                                                        <telerik:GridBoundColumn DataField="Name" AutoPostBackOnFilter="true" FilterControlAltText="Filter column column" FilterImageUrl="Filter.gif" HeaderText="SupSufix" SortAscImageUrl="SortAsc.gif" SortDescImageUrl="SortDesc.gif" SortExpression="Name" UniqueName="Name" Display="False">
