<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BankTransaction.aspx.cs" Inherits="ElectronicsMS.Forms.Forms.BankTransaction" %>
        ...
        <div>
            <table style="width: 80%">
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox ID="txtTransactionId" runat="server" EmptyMessage="Auto Generated Id" Enabled="False">
                        </telerik:RadTextBox>
                    </td>
                    <td>
                    ...
                    <td>
                        <telerik:RadDatePicker ID="dpTransactionDate" runat="server">
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadComboBox ID="cmTransactionType" Filter="Contains" EnableLoadOnDemand="true" runat="server" AutoPostBack="True" EmptyMessage="Select Transaction Type" OnSelectedIndexChanged="cmTransactionType_SelectedIndexChanged">
                            <Items>
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadComboBox ID="cmBankName" Filter="Contains" runat="server" Width="80%" EnableLoadOnDemand="true" EmptyMessage="Select Bank Name" OnItemsRequested="cmBankName_ItemsRequested" AutoPostBack="True" Filter="Contains" Height="400px" OnSelectedIndexChanged="cmBankName_SelectedIndexChanged">
                            <%--<HeaderTemplate>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label7" runat="server" Text="Remarks" Visible="False"></asp:Label>
                    </td>
                    <td>
                        <telerik:RadTextBox ID="txtRemarks" runat="server" Width="80%" TextMode="MultiLine" Visible="False">
                        </telerik:RadTextBox>
                    </td>
                    <td>&nbsp;</td>
                    <td style="margin-left: 40px">&nbsp;</td>
                ...
                <tr>
                    <td colspan="4">
                        ...
                        <telerik:RadButton ID="btnSave" runat="server" OnClick="btnSave_Click" SingleClick="true" SingleClickText="Working..." Text="Save">
                        </telerik:RadButton>
                ...
                <tr>
                    <td colspan="5">
                        <fieldset>
                            ...
                            <telerik:RadGrid runat="server" ID="RadGrid1" Width="100%" RenderMode="Auto" AllowMultiRowSelection="True" AutoGenerateColumns="False" OnNeedDataSource="RadGrid1_NeedDataSource"
                                ...
                                <MasterTableView>
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="Deposit" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" FilterControlAltText="Filter Deposit column" HeaderText="Deposit" SortExpression="Deposit" UniqueName="Deposit">
                                            <ColumnValidationSettings>
                                                <ModelErrorMessage Text="" />
                                            </ColumnValidationSettings>
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="Withdraw" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" FilterControlAltText="Filter Withdraw column" HeaderText="Withdraw" SortExpression="Withdraw" UniqueName="Withdraw">
                                            <ColumnValidationSettings>
                                                <ModelErrorMessage Text="" />
                                            </ColumnValidationSettings>
                                        </telerik:GridBoundColumn>
