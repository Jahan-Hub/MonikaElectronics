<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OpeningBalanceSup.aspx.cs" Inherits="ElectronicsMS.Forms.Forms.OpeningBalanceSup" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table style="width:40%">
            ...
            <tr>
                <td>
                    <asp:Label ID="Label11" runat="server" Text="Bill Date"></asp:Label>
                </td>
                <td>
                    <telerik:RadDatePicker ID="dpBillDate" Runat="server" Width="100px">
