...
{
    public partial class BankTransaction : Page
    {
        SqlConnection con;
        SqlCommand cmd;
        ...
        private void SaveData()
        {
            ...
            try
            {
                ...
                ButtonControl("L");
                EnableControl(false);
                lblMessage.Text = "Data of \"" + cmBankName.Text + "\" Saved Successfully.";
                ClearControl();
            }
            catch (Exception ex)
            {
        ...
        private void ReloadMainGrid()
        {
            try
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    if (dt.Rows[i]["ChequeDate"].ToString() != "")
        ...
        private void DataRefill()
        {
            try
            {
                ...
                string TrackId = selectedItem["TrackId"].Text;
                ViewState["TrackId"] = selectedItem["TrackId"].Text;
