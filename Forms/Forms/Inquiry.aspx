<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Inquiry.aspx.cs" Inherits="ElectronicsMS.Forms.Forms.Inquiry" %>
                ...
                <telerik:RadPanelItem runat="server" Text="Purchase">
                    <ContentTemplate>
                        <div style="overflow: scroll; height: 500px; width: 100%">
                            <telerik:RadGrid ID="rgPurchase" ShowFooter="True" GroupingSettings-CaseSensitive="false" Height="500px" Width="100%" runat="server" AllowMultiRowSelection="True" AutoGenerateColumns="False" GridLines="Both" PageSize="15" OnItemDataBound="rgPurchase_ItemDataBound">
                                ...
                                <MasterTableView AllowSorting="true" Width="100%" BorderWidth="0">
                                    ...
                                    <Columns>
                                        <telerik:GridBoundColumn DataField="PurDate" FilterControlAltText="Filter PurDate column" HeaderText="Purchase Date" SortExpression="PurDate" UniqueName="PurDate" DataFormatString="{0:dd/MM/yyyy}">
