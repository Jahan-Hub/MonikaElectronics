    ...
    public partial class Sales : Page
    {
        ...
        protected void btnPrintPreview_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //{
                //    lblMessage.Text = "You selected "+ cmInstallment.Text + " , but you do not Calculate yet the Installment.";
                //    return;
                //}
        ...
        private void GetReport()
        {
            //try
            //{
            //    con = new SqlConnection(ConfigurationManager.ConnectionStrings["EComMSDBConnectionString"].ConnectionString);
            //    con.Open();
            ...
            //    cmd.Parameters.Add("@SalesId", SqlDbType.VarChar).Value = txtSalesID.Text;
            //    cmd.Parameters.Add("@CustId", SqlDbType.Int).Value = Convert.ToInt32(cmCustomerName.SelectedValue);
            //    cmd.Parameters.Add("@PreviousDue", SqlDbType.Decimal).Value = Convert.ToDecimal(lblCustomerBalance.Text).ToString("00.");
            //    cmd.Parameters.Add("@DiscountYN", SqlDbType.VarChar).Value = "Y";
            //    SqlDataAdapter Dap = new SqlDataAdapter(cmd);
            ...
            //    reportName = "Challan";
            //    AppEnv.Current.p_rptObject = "~/Reports/ImpChallanA4Half.rpt";
            //    tempPath = @System.IO.Path.GetTempPath() + "Challan";

            //    //}
            //    AppEnv.Current.p_rptSource.Load(Server.MapPath(AppEnv.Current.p_rptObject.ToString()));
            //    AppEnv.Current.p_rptSource.SetDataSource(dt0);
            //    con.Close();
