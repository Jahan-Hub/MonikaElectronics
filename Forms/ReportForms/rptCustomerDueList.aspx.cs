...
{
    public partial class rptCustomerDueList : Page
    {
        SqlConnection con;
        SqlCommand Cmd;
        ...
        protected void btnGenerate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (cmThana.SelectedValue != "")
                    Cmd.Parameters.Add("@ThanaId", SqlDbType.VarChar).Value = cmThana.SelectedValue;
                if (cmVillage.SelectedValue != "")
                    Cmd.Parameters.Add("@ViId", SqlDbType.VarChar).Value = cmVillage.SelectedValue;
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    ((TextObject)AppEnv.Current.p_rptSource.ReportDefinition.Sections["Section1"].ReportObjects["txtDateRange"]).Text = "Customer Due List" + DateRange;
