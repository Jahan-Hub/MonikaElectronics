...
{
    public partial class rptExpense : Page
    {
        SqlConnection con;
        SqlCommand Cmd;
        ...
        protected void btnGenerate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (cmCostHead.SelectedValue != "")
                    Cmd.Parameters.Add("@CostCenterId", SqlDbType.Int).Value = cmCostHead.SelectedValue;
                ...
                tempPath = @System.IO.Path.GetTempPath() + "ExpenseReport";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    ((TextObject)AppEnv.Current.p_rptSource.ReportDefinition.Sections["Section1"].ReportObjects["txtDateRange"]).Text = "Expense Info: Date From " + String.Format("{0:dd/MM/yyyy}", dpFromDate.SelectedDate) + " To " + String.Format("{0:dd/MM/yyyy}", dpToDate.SelectedDate);
