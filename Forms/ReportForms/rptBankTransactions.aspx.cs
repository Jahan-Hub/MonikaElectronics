...
{
    public partial class rptBankTransactions : Page
    {
        SqlConnection con;
        SqlCommand Cmd;
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        //((TextObject)SalesMS.AppEnv.Current.p_rptSource.ReportDefinition.Sections["Section1"].ReportObjects["txtFax"]).Text = Session["Fax"].ToString();
                        //((TextObject)SalesMS.AppEnv.Current.p_rptSource.ReportDefinition.Sections["Section1"].ReportObjects["txtEmail"]).Text = Session["Email"].ToString();
                        //((TextObject)SalesMS.AppEnv.Current.p_rptSource.ReportDefinition.Sections["Section1"].ReportObjects["txtWebsite"]).Text = Session["Website"].ToString();
                        //((TextObject)SalesMS.AppEnv.Current.p_rptSource.ReportDefinition.Sections["Section1"].ReportObjects["txtCompanyMoto"]).Text = Session["CompanyMoto"].ToString();
                        //((TextObject)SalesMS.AppEnv.Current.p_rptSource.ReportDefinition.Sections["Section1"].ReportObjects["txtCompanyLogo"]).Text = Session["CompanyLogo"].ToString();
