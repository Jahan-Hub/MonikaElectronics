<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptProfitLoss.aspx.cs" Inherits="ElectronicsMS.Forms.rptProfitLoss" %>
    ...
    <div>
        ...
        <table>
            <tr>
                ...
                <td>
                    <telerik:RadComboBox ID="cmReportType" Runat="server" Filter="Contains" EnableLoadOnDemand="true" AutoPostBack="True" EmptyMessage="Select Report Type" OnSelectedIndexChanged="cmReportType_SelectedIndexChanged" Width="250px">
                        <Items>
